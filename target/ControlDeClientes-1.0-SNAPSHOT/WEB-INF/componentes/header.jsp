...
<header class="py-2 text-white" style="background-color: #2C3E50"> 
         <a class="nav-link active btn-icon" aria-current="page" href="./index.jsp">
    ...
    <h1 class="text-center">Aplicación Clientes</h1>
